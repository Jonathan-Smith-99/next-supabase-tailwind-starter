...
import background from "@/assets/banknotes.jpg"
      ...
      <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
        <div className="px-6 pb-24 pt-10 sm:pb-32 lg:col-span-7 lg:px-0 lg:pb-56 lg:pt-48 xl:col-span-6">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <h1 className="mt-24 text-3xl font-bold tracking-tight text-slate-100 sm:mt-10 sm:text-5xl">
              Take control of your personal finances
            </h1>
            <p className="mt-6 text-md leading-8 text-slate-200">
        ...
        <div className="relative lg:col-span-5 lg:-mr-8 xl:absolute xl:inset-0 xl:left-1/2 xl:mr-0">
          <Image
            className="w-full bg-black object-cover lg:absolute lg:inset-0 lg:aspect-auto lg:h-full"
            src={background}
            alt=""
          />
        </div>
